...
describe('AccountUsageCell', () => {
  ...
  it.each([
    { remaining: 500_000, expected: '500000' },
    { remaining: 1_000_000, expected: '1M' },
    { remaining: 500_000_000, expected: '500M' },
    { remaining: 1_000_000_000, expected: '1B' },
    { remaining: 10_000_000_000, expected: '10B' },
    { remaining: 50_000_000_000, expected: '50B' },
    { remaining: 1_000_000_000_000, expected: '1000B' },
    { remaining: 333_000_000_000_000, expected: '333000B' }
  ])('Grok renders available tokens without an upper unit cap: $expected', async ({ remaining, expected }) => {
    getUsage.mockResolvedValue({
      grok_free_token_limit: 1_000_000,
      subscription_tier: 'FREE',
      grok_token_quota: { limit: remaining, remaining },
      grok_local_usage_24h: {
        requests: 0,
        tokens: 0,
        cost: 0,
    ...
    await flushPromises()
    expect(wrapper.get('[data-testid="grok-available-tokens"]').text()).toContain(expected)
  })
