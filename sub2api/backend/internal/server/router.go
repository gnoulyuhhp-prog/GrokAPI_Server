...
func SetupRouter(
	...
	var frontendFallback gin.HandlerFunc
	...
	if web.HasEmbeddedFrontend() {
		...
		if err != nil {                                              //nolint:staticcheck // SA4023: see above
			...
			frontendFallback = web.ServeEmbeddedFrontend()
			...
			frontendFallback = frontendServer.Middleware()
		}
	} else {
		settingService.SetOnUpdateCallback(refreshFrameOrigins)
	}
	...
	if frontendFallback != nil {
		r.NoRoute(frontendFallback)
	}
